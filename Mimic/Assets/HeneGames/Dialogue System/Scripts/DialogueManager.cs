...
namespace HeneGames.DialogueSystem
{
    public class DialogueManager : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (isInTriggerZone && DialogueUI.instance.actionInput.WasPerformedThisFrame() && dialogueTrigger != null && !dialogueIsOn)
            {
        ...
        private void OnTriggerExit(Collider other)
        {
            ...
            if (other.gameObject.TryGetComponent<DialogueTrigger>(out DialogueTrigger _trigger) && dialogueIsOn == true)
            {
                //Hide interaction UI
                DialogueUI.instance.ShowInteractionUI(false);
